...
- Администратор
  - Оборудование
    ...
    - Сторудник
- Заявка
![](Lab1/diagrams/images/subject-area.png‎)

## Роли и пользователи

Роль | Назначение | Основные действия
-----|------------|------------------
Администратор | Полное управление учётом и системой | Создание, редактирование, удаление оборудования; управление пользователями; рассмотрение заявок
Руководитель | Контроль и мониторинг | Просмотр всех данных; фильтрация
